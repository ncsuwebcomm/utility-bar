(function(w,d,undefined){
	...
	w.addEventListener('load', function(){
		...
		bar.setAttribute('aria-label','NC State Brand Utility Bar');
 		...
 		if ((barPlaceholder = d.getElementById('ncstate-utility-bar')) && barPlaceholder.parentNode == documentBody) {
 			documentBody.replaceChild(bar, barPlaceholder);
		} else {
			documentBody.insertBefore(bar, documentBody.firstChild);
		}
