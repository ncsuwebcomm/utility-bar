...
<?php if(isset($_GET['googleCustomSearchCode']) || strlen($_GET['googleCustomSearchCode']) > 0): ?>
	_ub.googleCustomSearchCode = '<?php echo $_GET['googleCustomSearchCode']; ?>';
<?php endif; ?>

<?php if(isset($_GET['color']) || strlen($_GET['color']) > 0): ?>
	_ub.color = '<?php echo $_GET['color']; ?>';
<?php endif; ?>
...
(function(){
	...
	bar.src = ('https:' == document.location.protocol ? 'http://' : 'http://') + 'cdn.ncsu.edu/brand-assets/utility-bar/load-utility-bar.js';
