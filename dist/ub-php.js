...
var UtilityBar = function () {
    ...
    _createClass(UtilityBar, [{
        ...
        value: function initBarControls() {
            this.resourcesToggleBtn = document.getElementById('ncstate-utility-bar-toggle-link'), this.searchToggleBtn = document.getElementById('ncstate-utility-bar-search-btn'), this.linksPanel = document.getElementsByClassName('ncstate-utility-bar-links')[0], this.searchDialog = document.getElementsByClassName('ncstate-utility-bar-search-dialog')[0], this.searchInput = document.getElementsByClassName('ncstate-utility-bar-search-field')[0], this.firstLink = document.getElementById('ncstate-utility-bar-first-link'), this.hiddenClassPattern = /\bis-hidden\b/g, this.resourceToggleState = 'hidden';
        ...
        key: 'toggleSearchDialog',
        value: function toggleSearchDialog() {
            var _this2 = this;

            if (this.searchToggleState === 'hidden') {
                this.searchDialog.style.display = "flex";
                setTimeout(function () {
                    _this2.searchDialog.className = _this2.searchDialog.className.replace(_this2.hiddenClassPattern, '');
                }, 10);
        ...
        key: 'handleResourcesToggleButton',
        value: function handleResourcesToggleButton(e) {
            e.preventDefault();
        ...
        key: 'handleSearchToggleButton',
        value: function handleSearchToggleButton(e) {
            e.preventDefault();
        ...
        key: 'handleResourcesTabbedNavigation',
        value: function handleResourcesTabbedNavigation(e) {
